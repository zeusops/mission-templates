...
force ace_magazinerepack_timePerBeltLink = 4.52941;
force ace_magazinerepack_timePerMagazine = 2.0084;
...
// ACE Map Gestures
force ace_map_gestures_defaultColor = [1,0.778371,0,0.451574];
force ace_map_gestures_defaultLeadColor = [1,0.88,0,0.949197];
...
force ace_medical_playerDamageThreshold = 1.4881;
...
force ace_nightvision_effectScaling = 0.0840341;
...
STHud_Settings_Occlusion = false;
